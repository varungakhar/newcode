...
/* Fetch users from search item.
 * @param search term based on users search.
 */
- (NSString *)fetchPeopleFromSearchTerm:(NSString *)searchTerm
                                success:(void(^)(NSArray *people))success
                                failure:(CFCeflixServiceFailure)failure;
...
/* Fetch videos from search item.
 * @param search term based on users search.
 */
- (NSString *)fetchVideosFromSearchTerm:(NSString *)searchTerm
                                success:(void(^)(NSDictionary *videoDict))success
                                failure:(CFCeflixServiceFailure)failure;
...
/*
 * Fetch channels based on a search term
 * @param searchTerm The search term entered by the user
 */
- (NSString *)fetchChannelsFromSearchTerm:(NSString *)searchTerm
                                  success:(void(^)(NSDictionary *channelDict))success
                                  failure:(CFCeflixServiceFailure)failure;
